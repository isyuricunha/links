...
const links = [
  ...
  {
    name: "Figma",
    link: "links.yuricunha.com/figma",
    url: "https://www.figma.com/@isyuricunha",
  },
  {
    name: "GitHub",
  ...
  {
    name: "Dribbble",
    link: "links.yuricunha.com/dribbble",
    url: "https://dribbble.com/isyuricunha",
  },
  {
    name: "readcv",
  ...
  <div className="container">
    <main className="grid">
      ...
      <div className="card shadow card-quote">
        <p className="body-md">
          I excel in managing and optimizing complex databases, ensuring
          efficient data storage, retrieval, and security. My expertise lies in
          maintaining and fine-tuning database systems to support seamless
          business operations.
        </p>
      </div>
